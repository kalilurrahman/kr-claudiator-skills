---
name: reverse-etl
description: Design reverse ETL pipelines to sync data warehouse insights back to operational tools. Outputs sync architecture, transformation logic, scheduling strategy, and monitoring setup.
argument-hint: [source warehouse, destination tools, sync frequency, data volume]
allowed-tools: Read, Write
---

# Reverse Etl

REVERSE ETL is a critical engineering and product practice that requires systematic execution. This skill provides a proven framework for planning, executing, and validating reverse etl work.
...
The canonical implementation pattern for reverse etl work follows this structure:
...
The most frequent failure modes in reverse etl work are:
