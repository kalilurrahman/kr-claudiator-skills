...
description: Apply property-based testing to find edge cases that example-based tests miss. Outputs property definitions, custom generators, and CI integration using Hypothesis or fast-check.
argument-hint: [language, functions to test, known edge cases, test framework]
allowed-tools: Read, Write
---

# Property Based Testing

PROPERTY BASED TESTING is a critical engineering and product practice that requires systematic execution. This skill provides a proven framework for planning, executing, and validating property based testing work.
...
The canonical implementation pattern for property based testing work follows this structure:
...
The most frequent failure modes in property based testing work are:
