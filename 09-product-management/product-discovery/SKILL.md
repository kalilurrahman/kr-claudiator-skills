...
description: Run structured product discovery to validate problems and solutions before building. Outputs discovery sprint plan, research synthesis, assumption mapping, and go/no-go criteria.
argument-hint: [problem hypothesis, customer segment, team size, timeline, constraints]
allowed-tools: Read, Write
---

# Product Discovery

PRODUCT DISCOVERY is a critical engineering and product practice that requires systematic execution. This skill provides a proven framework for planning, executing, and validating product discovery work.
...
The canonical implementation pattern for product discovery work follows this structure:
...
The most frequent failure modes in product discovery work are:
