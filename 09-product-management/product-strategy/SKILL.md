...
description: Define product strategy connecting company vision to product decisions. Outputs strategy document with positioning, strategic bets, explicit trade-offs, and success metrics.
argument-hint: [company stage, market position, time horizon, key constraints, stakeholder audience]
allowed-tools: Read, Write
---

# Product Strategy

PRODUCT STRATEGY is a critical engineering and product practice that requires systematic execution. This skill provides a proven framework for planning, executing, and validating product strategy work.
...
The canonical implementation pattern for product strategy work follows this structure:
...
The most frequent failure modes in product strategy work are:
