...
description: Implement observability for LLM and ML systems in production. Outputs tracing setup, quality metrics, drift detection dashboards, and feedback collection pipeline.
argument-hint: [model types, traffic volume, quality metrics, monitoring stack]
allowed-tools: Read, Write
---

# Ai Observability

AI OBSERVABILITY is a critical engineering and product practice that requires systematic execution. This skill provides a proven framework for planning, executing, and validating ai observability work.
...
The canonical implementation pattern for ai observability work follows this structure:
...
The most frequent failure modes in ai observability work are:
