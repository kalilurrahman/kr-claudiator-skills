...
description: Run a phishing simulation program with cohorts, lures, and learning paths.
argument-hint: [org size, cadence, baselines]
...
The canonical workflow for **Phishing Simulation** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Run a phishing simulation program with cohorts, lures, and learning paths.
>
