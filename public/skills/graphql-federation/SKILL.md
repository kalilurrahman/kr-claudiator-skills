...
description: Architect a federated GraphQL graph with subgraphs and entity ownership.
argument-hint: [gateway, subgraphs, owners]
...
## When to use
Architect a federated GraphQL graph with subgraphs and entity ownership.
...
The canonical workflow for **Graphql Federation** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Architect a federated GraphQL graph with subgraphs and entity ownership.
>
