...
description: Build an opportunity-solution tree from a desired outcome and discovery insights.
argument-hint: [outcome, insights, horizon]
...
The canonical workflow for **Opportunity Tree** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Build an opportunity-solution tree from a desired outcome and discovery insights.
>
