---
name: ai-stakeholder-manager
description: Maps stakeholder needs, influence, communication, and alignment strategy.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Stakeholder Manager
...
> "Help me apply AI Stakeholder Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Stakeholder Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Maps stakeholder needs, influence, communication, and alignment strategy.
>
