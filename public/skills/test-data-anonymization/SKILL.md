...
description: Generate realistic, anonymized test data with referential integrity.
argument-hint: [source, scale, privacy class]
...
The canonical workflow for **Test Data Anonymization** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Generate realistic, anonymized test data with referential integrity.
>
