...
description: Design chunking, overlap, and metadata enrichment for production RAG.
argument-hint: [doc types, recall target, index]
...
The canonical workflow for **Rag Chunking Strategy** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Design chunking, overlap, and metadata enrichment for production RAG.
>
