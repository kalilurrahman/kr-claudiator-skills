...
The canonical workflow for **Ai Cost Optimisation** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Optimise LLM and AI infrastructure costs through model selection, caching, batching, and prompt engineering. Outputs cost analysis, model tiering strategy, and 
>
