---
name: tech-radar
description: Maintain a quarterly tech radar with adopt/trial/assess/hold rings and rationale.
argument-hint: [org, cadence, owners]
...
The canonical workflow for **Tech Radar** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Maintain a quarterly tech radar with adopt/trial/assess/hold rings and rationale.
>
