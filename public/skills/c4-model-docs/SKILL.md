---
name: c4-model-docs
description: Document a system using C4 (context, container, component) with consistent notation.
argument-hint: [system, audience, depth]
...
## When to use
Document a system using C4 (context, container, component) with consistent notation.
...
The canonical workflow for **C4 Model Docs** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Document a system using C4 (context, container, component) with consistent notation.
>
