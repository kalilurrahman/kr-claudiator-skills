---
name: jwt-hardening
description: Lock down JWT issuance, rotation, audience checks, and revocation paths.
argument-hint: [idp, audience, lifetime]
...
## When to use
Lock down JWT issuance, rotation, audience checks, and revocation paths.
...
The canonical workflow for **Jwt Hardening** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Lock down JWT issuance, rotation, audience checks, and revocation paths.
>
