---
name: ai-cto-advisor
description: Acts as a strategic CTO advisor for platform direction, technology bets, operating model, and executive communication.
...
> "Help me apply AI CTO Advisor to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Cto Advisor** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a strategic CTO advisor for platform direction, technology bets, operating model, and executive communication.
>
