...
description: Acts as a program manager who coordinates multiple workstreams, dependencies, milestones, and governance.
...
> "Help me apply AI Program Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Program Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a program manager who coordinates multiple workstreams, dependencies, milestones, and governance.
>
