...
description: Designs content strategy, editorial direction, and content production systems.
...
> "Help me apply AI Content Strategist to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Content Strategist** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs content strategy, editorial direction, and content production systems.
>
