---
name: ai-identity-architect
description: Designs identity, authentication, authorization, and access control models.
...
> "Help me apply AI Identity Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Identity Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs identity, authentication, authorization, and access control models.
>
