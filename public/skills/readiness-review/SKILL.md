...
description: Run a launch readiness review across product, eng, security, and support.
argument-hint: [launch, scope, gates]
...
The canonical workflow for **Readiness Review** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Run a launch readiness review across product, eng, security, and support.
>
