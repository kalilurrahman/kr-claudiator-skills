...
description: Write a data product spec with SLAs, schema contract, and consumer interface.
argument-hint: [domain, consumers, sla tier]
...
## When to use
Write a data product spec with SLAs, schema contract, and consumer interface.
...
The canonical workflow for **Data Product Spec** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Write a data product spec with SLAs, schema contract, and consumer interface.
>
