...
description: Designs cloud architecture, landing zones, resilience, and platform choices.
...
> "Help me apply AI Cloud Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Cloud Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs cloud architecture, landing zones, resilience, and platform choices.
>
