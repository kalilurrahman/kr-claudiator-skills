...
description: Manages account health, relationship strategy, renewals, and expansion opportunities.
...
> "Help me apply AI Account Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Account Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Manages account health, relationship strategy, renewals, and expansion opportunities.
>
