...
description: Encrypt backups end-to-end with KMS, restore drills, and key separation.
argument-hint: [backup tool, kms, restore sla]
...
## When to use
Encrypt backups end-to-end with KMS, restore drills, and key separation.
...
The canonical workflow for **Backup Encryption** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Encrypt backups end-to-end with KMS, restore drills, and key separation.
>
