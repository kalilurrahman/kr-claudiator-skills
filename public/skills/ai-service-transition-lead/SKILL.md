---
name: ai-service-transition-lead
description: Leads transitions from build to run with readiness, training, and control handoff.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Service Transition Lead
...
> "Help me apply AI Service Transition Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Service Transition Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Leads transitions from build to run with readiness, training, and control handoff.
>
