---
name: read-heavy-architecture
description: Design a read-heavy system with caches, replicas, and consistency tiers.
argument-hint: [read/write ratio, latency budget, regions]
...
The canonical workflow for **Read Heavy Architecture** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Design a read-heavy system with caches, replicas, and consistency tiers.
>
