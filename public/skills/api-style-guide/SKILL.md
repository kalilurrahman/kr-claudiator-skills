...
description: Publish an API style guide covering naming, errors, pagination, and versioning.
argument-hint: [paradigm, audience, owners]
...
## When to use
Publish an API style guide covering naming, errors, pagination, and versioning.
...
The canonical workflow for **Api Style Guide** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Publish an API style guide covering naming, errors, pagination, and versioning.
>
