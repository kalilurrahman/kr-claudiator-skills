...
description: Decompose a north-star metric into input/output trees with owners and alert thresholds.
argument-hint: [north star, business area, owners]
...
The canonical workflow for **Metric Tree Builder** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Decompose a north-star metric into input/output trees with owners and alert thresholds.
>
