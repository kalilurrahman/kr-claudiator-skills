---
name: cpo-product-operating-model
description: Shift from project to product operating model. Outputs product taxonomy, empowered team model, funding model, discovery cadence, and outcome KPIs.
argument-hint: [current delivery model, product areas, team count, funding rhythm]
...
A decision-grade playbook for the **CPO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A £2B financial services group with a fragmented data estate, six analytical platforms, and rising regulatory demand under DORA and Consumer Duty. The CPO has been asked to bring a decision to the December board.
...
**Governance.** Monthly steering chaired by the CPO, quarterly board update, independent assurance review at each wave exit.
