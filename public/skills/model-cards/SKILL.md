---
name: model-cards
description: Author a model card covering intended use, evals, risks, and update cadence.
argument-hint: [model family, dataset, owners]
...
The canonical workflow for **Model Cards** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Author a model card covering intended use, evals, risks, and update cadence.
>
