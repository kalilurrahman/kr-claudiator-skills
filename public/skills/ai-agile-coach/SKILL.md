---
name: ai-agile-coach
description: Acts as an agile coach who improves sprint flow, backlog hygiene, ceremonies, and delivery discipline.
...
> "Help me apply AI Agile Coach to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Agile Coach** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as an agile coach who improves sprint flow, backlog hygiene, ceremonies, and delivery discipline.
>
