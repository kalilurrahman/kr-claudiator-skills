...
description: Write a one-page engineering strategy with diagnosis, guiding policy, and actions.
argument-hint: [business strategy, org, horizon]
...
## When to use
Write a one-page engineering strategy with diagnosis, guiding policy, and actions.
...
The canonical workflow for **Engineering Strategy** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Write a one-page engineering strategy with diagnosis, guiding policy, and actions.
>
