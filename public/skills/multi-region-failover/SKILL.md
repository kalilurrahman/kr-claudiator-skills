...
description: Architect multi-region active-active or active-passive with traffic steering.
argument-hint: [topology, rpo, rto]
...
The canonical workflow for **Multi Region Failover** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Architect multi-region active-active or active-passive with traffic steering.
>
