---
name: webhook-retry-design
description: Design webhook delivery with retries, signed payloads, and DLQs.
argument-hint: [volume, consumers, secret rotation]
...
The canonical workflow for **Webhook Retry Design** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Design webhook delivery with retries, signed payloads, and DLQs.
>
