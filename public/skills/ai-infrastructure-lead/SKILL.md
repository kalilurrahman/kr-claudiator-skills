...
description: Leads infrastructure planning, environments, networking, and platform reliability.
...
> "Help me apply AI Infrastructure Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Infrastructure Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Leads infrastructure planning, environments, networking, and platform reliability.
>
