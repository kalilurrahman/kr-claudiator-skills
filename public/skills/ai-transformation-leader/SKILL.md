...
description: Acts as a transformation leader who drives operating-model and technology change across an organization.
...
> "Help me apply AI Transformation Leader to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Transformation Leader** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a transformation leader who drives operating-model and technology change across an organization.
>
