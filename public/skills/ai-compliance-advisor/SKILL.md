---
name: ai-compliance-advisor
description: Advises on compliance, controls, auditability, and regulated operating models.
...
> "Help me apply AI Compliance Advisor to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Compliance Advisor** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Advises on compliance, controls, auditability, and regulated operating models.
>
