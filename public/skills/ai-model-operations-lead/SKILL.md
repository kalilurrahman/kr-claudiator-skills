---
name: ai-model-operations-lead
description: Manages model deployment, evaluation, drift monitoring, and AI operations.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Model Operations Lead
...
> "Help me apply AI Model Operations Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Model Operations Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Manages model deployment, evaluation, drift monitoring, and AI operations.
>
