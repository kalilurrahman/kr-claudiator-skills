...
description: Builds lead generation systems, targeting logic, and funnel entry workflows.
...
> "Help me apply AI Lead Generator to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Lead Generator** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Builds lead generation systems, targeting logic, and funnel entry workflows.
>
