...
The canonical workflow for **Multimodal Ai** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Build applications that combine text, image, audio, and structured data with multimodal AI models. Outputs input processing pipelines, prompt strategies, and ev
>
