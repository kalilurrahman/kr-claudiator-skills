...
description: Designs logs, metrics, traces, alerting, and operational visibility.
...
> "Help me apply AI Observability Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Observability Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs logs, metrics, traces, alerting, and operational visibility.
>
