...
description: Evolve event/API schemas with compatibility rules and consumer rollouts.
argument-hint: [registry, consumers, cadence]
...
The canonical workflow for **Schema Evolution** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Evolve event/API schemas with compatibility rules and consumer rollouts.
>
