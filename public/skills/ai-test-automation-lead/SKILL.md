...
description: Designs automated testing strategy, coverage, tooling, and CI quality flows.
...
> "Help me apply AI Test Automation Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Test Automation Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs automated testing strategy, coverage, tooling, and CI quality flows.
>
