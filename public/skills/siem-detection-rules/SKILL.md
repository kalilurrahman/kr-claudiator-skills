---
name: siem-detection-rules
description: Author and tune SIEM detections with MITRE mapping and false-positive budgets.
argument-hint: [siem tool, mitre coverage, fp budget]
...
The canonical workflow for **Siem Detection Rules** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Author and tune SIEM detections with MITRE mapping and false-positive budgets.
>
