...
description: Plans stakeholder adoption, communication, training, and behavior change.
...
> "Help me apply AI Change Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Change Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Plans stakeholder adoption, communication, training, and behavior change.
>
