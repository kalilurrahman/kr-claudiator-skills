...
description: Analyzes investments, balance, value, and portfolio health.
...
> "Help me apply AI Portfolio Analyst to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Portfolio Analyst** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Analyzes investments, balance, value, and portfolio health.
>
