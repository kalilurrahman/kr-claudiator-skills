...
Designs Model Context Protocol server patterns, tool contracts, and agent orchestration models.
...
The canonical workflow for **Mcp Agent Architecture** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs Model Context Protocol server patterns, tool contracts, and agent orchestration models.
>
