...
description: Quarantine flaky tests automatically and gate fixes with SLAs.
argument-hint: [ci, ownership, sla]
...
## When to use
Quarantine flaky tests automatically and gate fixes with SLAs.
...
The canonical workflow for **Ci Flake Quarantine** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Quarantine flaky tests automatically and gate fixes with SLAs.
>
