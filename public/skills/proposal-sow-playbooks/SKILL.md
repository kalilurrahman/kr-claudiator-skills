# Proposal and SOW Playbooks

## What this skill does
Creates proposal structures, SOW outlines, scope controls, staffing assumptions, and differentiators.
...
The canonical workflow for **Proposal Sow Playbooks** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Creates proposal structures, SOW outlines, scope controls, staffing assumptions, and differentiators.
>
