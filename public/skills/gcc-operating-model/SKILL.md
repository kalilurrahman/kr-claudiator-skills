...
Designs GCC structures, service delivery models, governance, and scaling mechanisms.
...
The canonical workflow for **Gcc Operating Model** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs GCC structures, service delivery models, governance, and scaling mechanisms.
>
