...
description: Capture a decision with options, trade-offs, and a reversibility tag.
argument-hint: [decision, options, reversibility]
...
## When to use
Capture a decision with options, trade-offs, and a reversibility tag.
...
The canonical workflow for **Decision Record** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Capture a decision with options, trade-offs, and a reversibility tag.
>
