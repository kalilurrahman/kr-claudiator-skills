---
name: queue-vs-stream-decision
description: Choose between queues and streams given ordering, retention, and replay needs.
argument-hint: [ordering, retention, throughput]
...
The canonical workflow for **Queue Vs Stream Decision** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Choose between queues and streams given ordering, retention, and replay needs.
>
