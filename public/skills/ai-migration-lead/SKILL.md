...
description: Plans and governs technology migrations with sequencing, risk control, and cutover strategy.
...
> "Help me apply AI Migration Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Migration Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Plans and governs technology migrations with sequencing, risk control, and cutover strategy.
>
