---
name: ai-stakeholder-communications-lead
description: Crafts stakeholder messaging, updates, and alignment communications.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Stakeholder Communications Lead

Cross-functional work fails at the seams between teams, not inside them. The output of this skill is a shared artefact that every function involved can point to and execute against — no implicit ownership, no shadow dependencies.

## When to invoke this skill

Use this skill when two or more functions need to align on an outcome, ownership is unclear, or a recurring handoff is failing. It is most valuable early — before a decision is locked in — but it is equally useful as a structured review when an existing approach is being questioned by product, engineering, design, marketing, sales, support, and operations leads.
...
7. **Document the decision** in RACI charts, working agreements, and shared roadmaps so future readers understand not just *what* was chosen but *why*.
...
The canonical workflow for **Ai Stakeholder Communications Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Crafts stakeholder messaging, updates, and alignment communications.
>
