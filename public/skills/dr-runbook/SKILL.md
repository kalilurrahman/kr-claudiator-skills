---
name: dr-runbook
description: Build a tested disaster-recovery runbook covering RPO, RTO, and failover drills.
argument-hint: [critical services, region strategy, RPO/RTO]
...
## When to use
Build a tested disaster-recovery runbook covering RPO, RTO, and failover drills.
...
The canonical workflow for **Dr Runbook** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Build a tested disaster-recovery runbook covering RPO, RTO, and failover drills.
>
