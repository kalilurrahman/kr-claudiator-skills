...
description: Supports technical discovery, demos, solution fit, and pre-sales architecture.
...
> "Help me apply AI Sales Engineer to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Sales Engineer** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Supports technical discovery, demos, solution fit, and pre-sales architecture.
>
