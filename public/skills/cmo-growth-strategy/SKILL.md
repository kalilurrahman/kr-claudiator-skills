...
description: Board-grade growth strategy across segments, ICP, positioning, pricing, and channel mix. Outputs value hypothesis, growth model, GTM waves, and marketing operating budget with unit economics.
argument-hint: [market, ICP, current ARR, growth target, budget envelope]
allowed-tools: Read, Write
audience: CMO
---

# CMO Growth & GTM Strategy

A decision-grade playbook for the **CMO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A mid-cap enterprise where the CMO has been asked to bring a decision to the next board meeting on the topic described in the argument hint.
...
**Governance.** Monthly steering chaired by the CMO, quarterly board update, independent assurance review at each wave exit.
