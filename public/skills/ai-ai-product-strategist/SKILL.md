---
name: ai-ai-product-strategist
description: Shapes strategy for AI-native products, differentiation, and responsible AI adoption.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI AI Product Strategist
...
> "Help me apply AI AI Product Strategist to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Ai Product Strategist** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Shapes strategy for AI-native products, differentiation, and responsible AI adoption.
>
