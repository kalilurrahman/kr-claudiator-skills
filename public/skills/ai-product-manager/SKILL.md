...
description: Acts as a product manager who connects customer needs, market context, roadmap, metrics, and delivery strategy.
...
> "Help me apply AI Product Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Product Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a product manager who connects customer needs, market context, roadmap, metrics, and delivery strategy.
>
