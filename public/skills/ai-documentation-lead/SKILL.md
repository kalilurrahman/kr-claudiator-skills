...
description: Produces structured documentation, onboarding guides, and technical references.
...
> "Help me apply AI Documentation Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Documentation Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Produces structured documentation, onboarding guides, and technical references.
>
