...
description: Integrates systems end-to-end, aligning data, APIs, and workflows.
...
> "Help me apply AI Systems Integrator to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Systems Integrator** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Integrates systems end-to-end, aligning data, APIs, and workflows.
>
