...
description: Author reusable Terraform modules with versioning, examples, and integration tests.
argument-hint: [cloud, scope, consumers]
...
The canonical workflow for **Terraform Module Design** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Author reusable Terraform modules with versioning, examples, and integration tests.
>
