...
description: Leads incident response, coordination, communication, and recovery prioritization.
...
> "Help me apply AI Incident Commander to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Incident Commander** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Leads incident response, coordination, communication, and recovery prioritization.
>
