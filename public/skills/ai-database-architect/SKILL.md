...
description: Designs relational data models, indexing, performance, and data governance.
...
> "Help me apply AI Database Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Database Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs relational data models, indexing, performance, and data governance.
>
