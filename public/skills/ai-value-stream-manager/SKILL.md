---
name: ai-value-stream-manager
description: Optimizes delivery flow across the value stream from idea to production.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Value Stream Manager
...
> "Help me apply AI Value Stream Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Value Stream Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Optimizes delivery flow across the value stream from idea to production.
>
