---
name: cto-tech-debt-portfolio
description: Quantify and prioritise technology debt as a portfolio with interest rate, principal, and remediation ROI. Outputs debt register, quarterly paydown plan, and executive dashboard.
argument-hint: [systems in scope, incident data, delivery friction signals, budget]
