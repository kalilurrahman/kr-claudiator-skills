---
name: ai-delivery-analyst
description: Tracks delivery performance, bottlenecks, and throughput improvements.
...
> "Help me apply AI Delivery Analyst to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Delivery Analyst** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Tracks delivery performance, bottlenecks, and throughput improvements.
>
