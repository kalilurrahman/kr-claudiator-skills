---
name: talent-density
description: Raise talent density: calibration, performance bar, and growth ladders.
argument-hint: [org size, function, current bar]
...
The canonical workflow for **Talent Density** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Raise talent density: calibration, performance bar, and growth ladders.
>
