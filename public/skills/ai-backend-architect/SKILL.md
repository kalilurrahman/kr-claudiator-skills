...
description: Designs backend systems, APIs, services, data access, and scalability patterns.
...
> "Help me apply AI Backend Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Backend Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs backend systems, APIs, services, data access, and scalability patterns.
>
