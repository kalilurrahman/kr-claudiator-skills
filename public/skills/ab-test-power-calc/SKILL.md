---
name: ab-test-power-calc
description: Calculate sample size and runtime for an A/B test given variance and MDE.
argument-hint: [baseline, MDE, traffic, variance]
...
The canonical workflow for **Ab Test Power Calc** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Calculate sample size and runtime for an A/B test given variance and MDE.
>
