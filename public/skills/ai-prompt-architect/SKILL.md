...
description: Designs prompt patterns, instructions, guardrails, and LLM interaction quality.
...
> "Help me apply AI Prompt Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Prompt Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs prompt patterns, instructions, guardrails, and LLM interaction quality.
>
