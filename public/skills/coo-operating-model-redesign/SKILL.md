---
name: coo-operating-model-redesign
description: Redesign the enterprise operating model — process, org, tech, data, governance — to unlock 15-25% productivity. Outputs current/target state, gap analysis, and transition plan.
argument-hint: [current model, pain points, target outcomes, geographies]
...
A decision-grade playbook for the **COO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A £2B financial services group with a fragmented data estate, six analytical platforms, and rising regulatory demand under DORA and Consumer Duty. The COO has been asked to bring a decision to the December board.
...
**Governance.** Monthly steering chaired by the COO, quarterly board update, independent assurance review at each wave exit.
