...
description: Stand up a feature store with offline/online parity and point-in-time correctness.
argument-hint: [platform, freshness sla, consumers]
...
The canonical workflow for **Ml Feature Store** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Stand up a feature store with offline/online parity and point-in-time correctness.
>
