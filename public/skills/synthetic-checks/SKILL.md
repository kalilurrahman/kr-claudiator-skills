...
description: Define synthetic monitoring journeys with SLO-aligned alerts.
argument-hint: [journeys, regions, slo]
...
The canonical workflow for **Synthetic Checks** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Define synthetic monitoring journeys with SLO-aligned alerts.
>
