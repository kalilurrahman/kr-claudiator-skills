---
name: api-fuzzing
description: Set up schema-driven API fuzzing with crash triage and replay.
argument-hint: [openapi/proto, runtime, severity gate]
...
## When to use
Set up schema-driven API fuzzing with crash triage and replay.
...
The canonical workflow for **Api Fuzzing** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Set up schema-driven API fuzzing with crash triage and replay.
>
