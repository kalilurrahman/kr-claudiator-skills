...
description: Set up blue-green deploys with traffic shift, smoke tests, and instant rollback.
argument-hint: [platform, traffic source, health gates]
...
## When to use
Set up blue-green deploys with traffic shift, smoke tests, and instant rollback.
...
The canonical workflow for **Blue Green Deployment** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Set up blue-green deploys with traffic shift, smoke tests, and instant rollback.
>
