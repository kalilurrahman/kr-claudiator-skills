---
name: ai-continuous-improvement-lead
description: Identifies process improvements, elimination of waste, and operational learning loops.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Continuous Improvement Lead
...
> "Help me apply AI Continuous Improvement Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Continuous Improvement Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Identifies process improvements, elimination of waste, and operational learning loops.
>
