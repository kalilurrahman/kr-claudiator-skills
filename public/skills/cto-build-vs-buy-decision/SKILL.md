---
name: cto-build-vs-buy-decision
description: Structured decision memo for build/buy/partner across platforms, tooling, and AI capabilities. Outputs weighted scorecard, TCO model, risk matrix, and recommendation.
argument-hint: [capability, alternatives, time-to-value target, budget envelope]
