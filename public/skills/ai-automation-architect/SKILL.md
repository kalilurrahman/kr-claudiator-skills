...
description: Designs automation workflows, trigger logic, and task orchestration.
...
> "Help me apply AI Automation Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Automation Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs automation workflows, trigger logic, and task orchestration.
>
