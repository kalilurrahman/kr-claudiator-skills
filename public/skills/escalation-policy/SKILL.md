...
description: Define escalation tiers, response SLAs, and on-call interlocks.
argument-hint: [severity matrix, channels, oncall]
...
## When to use
Define escalation tiers, response SLAs, and on-call interlocks.
...
The canonical workflow for **Escalation Policy** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Define escalation tiers, response SLAs, and on-call interlocks.
>
