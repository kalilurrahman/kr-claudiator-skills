...
description: Define automated architectural fitness functions and wire them into CI.
argument-hint: [characteristics, ci, gates]
...
## When to use
Define automated architectural fitness functions and wire them into CI.
...
The canonical workflow for **Fitness Functions** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Define automated architectural fitness functions and wire them into CI.
>
