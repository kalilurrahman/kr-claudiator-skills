...
description: Designs experiments, hypotheses, success criteria, and decision logic.
...
> "Help me apply AI Experiment Designer to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Experiment Designer** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs experiments, hypotheses, success criteria, and decision logic.
>
