...
description: Designs APIs, versioning strategy, request/response contracts, and integration patterns.
...
> "Help me apply AI API Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Api Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs APIs, versioning strategy, request/response contracts, and integration patterns.
>
