---
name: raci-builder
description: Build a tight RACI matrix for a cross-team initiative.
argument-hint: [initiative, teams, decisions]
...
The canonical workflow for **Raci Builder** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Build a tight RACI matrix for a cross-team initiative.
>
