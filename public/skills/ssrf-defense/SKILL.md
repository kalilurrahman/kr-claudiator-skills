---
name: ssrf-defense
description: Add allowlists, metadata blocks, and egress controls to defeat SSRF.
argument-hint: [language, egress topology, cloud]
...
The canonical workflow for **Ssrf Defense** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Add allowlists, metadata blocks, and egress controls to defeat SSRF.
>
