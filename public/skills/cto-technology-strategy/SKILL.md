...
description: Build a 3-horizon technology strategy that ties architecture bets, platform investments, and org capability to enterprise OKRs. Outputs a board-ready narrative, roadmap, and investment plan.
argument-hint: [business context, horizon (12/24/36mo), constraints, target outcomes]
allowed-tools: Read, Write
audience: CTO
---

# CTO Technology Strategy & Roadmap
