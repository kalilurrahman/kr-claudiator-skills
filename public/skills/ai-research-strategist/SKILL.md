...
description: Shapes research plans, hypotheses, and evidence-based strategic direction.
...
> "Help me apply AI Research Strategist to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Research Strategist** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Shapes research plans, hypotheses, and evidence-based strategic direction.
>
