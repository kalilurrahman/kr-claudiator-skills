...
description: Acts as a product researcher who gathers customer insight, market signals, and evidence for product decisions.
...
> "Help me apply AI Product Researcher to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Product Researcher** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a product researcher who gathers customer insight, market signals, and evidence for product decisions.
>
