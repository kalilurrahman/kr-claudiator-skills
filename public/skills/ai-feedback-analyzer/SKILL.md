...
description: Analyzes customer and employee feedback into themes, priorities, and actions.
...
> "Help me apply AI Feedback Analyzer to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Feedback Analyzer** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Analyzes customer and employee feedback into themes, priorities, and actions.
>
