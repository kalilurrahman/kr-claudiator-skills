...
description: Audit developer experience across build, test, deploy, and feedback loops and ship the top three improvements.
argument-hint: [team size, current cycle time, top pain points]
...
## When to use
Audit developer experience across build, test, deploy, and feedback loops and ship the top three improvements.

## Process
1. Measure cycle time, build time, test time, and time-to-first-PR.
2. Survey engineers on top three frictions and rank by frequency × pain.
3. Map current toolchain and identify duplicate or low-leverage steps.
4. Propose three improvements with effort vs. expected reduction.
5. Pilot on one team, measure delta, then roll out.

## Output template
- **Baseline metrics** — measured cycle/build/test times
- **Top frictions** — ranked list with quotes
- **Improvement bets** — top 3 with owner and ETA
- **Pilot plan** — team, duration, success metric
- **Rollout** — phased adoption plan

## Anti-patterns
- Optimising the loudest voice, not the highest leverage.
- Adding tools without retiring others.

## Rules
1. Measure before changing.
2. Pick three, not thirty.
3. Pilot before rollout.
4. Retire something for every tool added.
...
The canonical workflow for **Developer Experience Audit** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Audit developer experience across build, test, deploy, and feedback loops and ship the top three improvements.
>
