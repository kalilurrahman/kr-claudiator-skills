...
description: Advises on software procurement, vendor evaluation, contracting, and cost control.
...
> "Help me apply AI Procurement Advisor to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Procurement Advisor** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Advises on software procurement, vendor evaluation, contracting, and cost control.
>
