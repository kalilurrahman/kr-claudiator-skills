...
description: Designs governance, decision rights, standards, and controls across teams.
...
> "Help me apply AI Governance Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Governance Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs governance, decision rights, standards, and controls across teams.
>
