---
name: etl-connector-spec
description: Spec a third-party connector with rate-limit handling, pagination, and resumes.
argument-hint: [source, volume, sla]
...
## When to use
Spec a third-party connector with rate-limit handling, pagination, and resumes.
...
The canonical workflow for **Etl Connector Spec** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Spec a third-party connector with rate-limit handling, pagination, and resumes.
>
