---
name: ai-partner-success-lead
description: Manages partner onboarding, enablement, and ecosystem execution.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Partner Success Lead
...
> "Help me apply AI Partner Success Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Partner Success Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Manages partner onboarding, enablement, and ecosystem execution.
>
