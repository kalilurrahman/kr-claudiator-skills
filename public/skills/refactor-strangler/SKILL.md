---
name: refactor-strangler
description: Apply the strangler pattern to retire a legacy module without freezing delivery.
argument-hint: [legacy area, target, migration window]
...
The canonical workflow for **Refactor Strangler** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Apply the strangler pattern to retire a legacy module without freezing delivery.
>
