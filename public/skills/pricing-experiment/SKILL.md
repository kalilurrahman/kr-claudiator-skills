...
description: Design a pricing experiment with willingness-to-pay tests and guardrails.
argument-hint: [plan structure, segments, guardrails]
...
The canonical workflow for **Pricing Experiment** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Design a pricing experiment with willingness-to-pay tests and guardrails.
>
