...
Structures denial prevention, classification, appeals, and root-cause remediation programs.
...
The canonical workflow for **Denial Management Playbook** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Structures denial prevention, classification, appeals, and root-cause remediation programs.
>
