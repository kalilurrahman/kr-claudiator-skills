...
description: Audit current test pyramid and rebalance unit/integration/e2e investment.
argument-hint: [stack, current ratio, target ratio]
...
The canonical workflow for **Test Pyramid Audit** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Audit current test pyramid and rebalance unit/integration/e2e investment.
>
