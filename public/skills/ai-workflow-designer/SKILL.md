...
description: Designs operational workflows, process maps, and handoff logic.
...
> "Help me apply AI Workflow Designer to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Workflow Designer** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs operational workflows, process maps, and handoff logic.
>
