---
name: ai-customer-success-advisor
description: Improves onboarding, retention, support, and value realization for customers.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Customer Success Advisor
...
> "Help me apply AI Customer Success Advisor to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Customer Success Advisor** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Improves onboarding, retention, support, and value realization for customers.
>
