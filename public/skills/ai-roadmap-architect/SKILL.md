---
name: ai-roadmap-architect
description: Designs roadmap sequencing, dependencies, and phased capability evolution.
...
> "Help me apply AI Roadmap Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Roadmap Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs roadmap sequencing, dependencies, and phased capability evolution.
>
