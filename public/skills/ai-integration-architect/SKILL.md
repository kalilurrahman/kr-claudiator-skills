...
description: Designs system integrations, event flows, middleware, and interoperability.
...
> "Help me apply AI Integration Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Integration Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs system integrations, event flows, middleware, and interoperability.
>
