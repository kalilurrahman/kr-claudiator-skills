...
description: Defines metrics, dashboards, reporting logic, and decision analytics.
...
> "Help me apply AI Analytics Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Analytics Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Defines metrics, dashboards, reporting logic, and decision analytics.
>
