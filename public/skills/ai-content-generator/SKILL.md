...
description: Produces content systems, drafts, and channel-specific content outputs.
...
> "Help me apply AI Content Generator to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Content Generator** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Produces content systems, drafts, and channel-specific content outputs.
>
