...
description: Acts as a release manager who coordinates release planning, cutovers, approvals, and rollback readiness.
...
> "Help me apply AI Release Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Release Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a release manager who coordinates release planning, cutovers, approvals, and rollback readiness.
>
