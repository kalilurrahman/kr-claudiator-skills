...
description: Acts as a product strategist who frames positioning, differentiation, and long-term product direction.
...
> "Help me apply AI Product Strategist to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Product Strategist** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a product strategist who frames positioning, differentiation, and long-term product direction.
>
