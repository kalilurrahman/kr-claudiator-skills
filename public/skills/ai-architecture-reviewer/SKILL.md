...
description: Reviews architectures for fitness, tradeoffs, anti-patterns, and delivery readiness.
...
> "Help me apply AI Architecture Reviewer to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Architecture Reviewer** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Reviews architectures for fitness, tradeoffs, anti-patterns, and delivery readiness.
>
