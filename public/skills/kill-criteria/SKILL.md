---
name: kill-criteria
description: Define explicit kill criteria for a bet to prevent zombie initiatives.
argument-hint: [bet, time box, signals]
...
## When to use
Define explicit kill criteria for a bet to prevent zombie initiatives.
...
The canonical workflow for **Kill Criteria** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Define explicit kill criteria for a bet to prevent zombie initiatives.
>
