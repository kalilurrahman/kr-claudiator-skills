...
description: Run a blameless postmortem and convert findings into trackable corrective actions.
argument-hint: [incident scope, severity, stakeholders]
...
## When to use
Run a blameless postmortem and convert findings into trackable corrective actions.
...
The canonical workflow for **Incident Postmortem** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Run a blameless postmortem and convert findings into trackable corrective actions.
>
