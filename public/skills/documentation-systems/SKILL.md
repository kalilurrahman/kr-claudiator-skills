...
Designs documentation structures for product, operations, testing, and transformation programs.
...
The canonical workflow for **Documentation Systems** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs documentation structures for product, operations, testing, and transformation programs.
>
