---
name: ai-training-lead
description: Designs training plans, enablement content, and learning rollouts.
...
> "Help me apply AI Training Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Training Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs training plans, enablement content, and learning rollouts.
>
