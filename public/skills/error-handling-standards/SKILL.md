...
description: Define error taxonomy, retry policy, and structured logging conventions for a service.
argument-hint: [language, transport, observability stack]
...
## When to use
Define error taxonomy, retry policy, and structured logging conventions for a service.
...
The canonical workflow for **Error Handling Standards** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Define error taxonomy, retry policy, and structured logging conventions for a service.
>
