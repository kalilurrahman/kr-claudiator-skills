...
description: Acts as an operations lead who manages reliability, support, incident response, and service health.
...
> "Help me apply AI Operations Lead to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Operations Lead** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as an operations lead who manages reliability, support, incident response, and service health.
>
