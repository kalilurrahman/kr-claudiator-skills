# Enterprise Application Implementation Playbook

## What this skill does
Defines end-to-end implementation structures, governance, testing, and deployment patterns for enterprise platforms.
...
The canonical workflow for **Enterprise App Implementation** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Defines end-to-end implementation structures, governance, testing, and deployment patterns for enterprise platforms.
>
