# RCM Metrics and KPI Design

## What this skill does
Defines a KPI framework for front-end, coding, billing, denials, AR, and cash operations.
...
The canonical workflow for **Rcm Metrics Kpis** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Defines a KPI framework for front-end, coding, billing, denials, AR, and cash operations.
>
