...
description: Identifies strategic, delivery, operational, and technology risks with mitigations.
...
> "Help me apply AI Risk Advisor to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Risk Advisor** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Identifies strategic, delivery, operational, and technology risks with mitigations.
>
