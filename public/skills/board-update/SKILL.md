---
name: board-update
description: Compose a focused board update covering metrics, risks, asks, and decisions.
argument-hint: [stage, audience, period]
...
## When to use
Compose a focused board update covering metrics, risks, asks, and decisions.
...
The canonical workflow for **Board Update** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Compose a focused board update covering metrics, risks, asks, and decisions.
>
