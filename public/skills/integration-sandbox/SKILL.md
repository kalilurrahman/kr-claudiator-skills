...
description: Provision a vendor integration sandbox with mocks and contract pinning.
argument-hint: [vendor, scenarios, refresh]
...
## When to use
Provision a vendor integration sandbox with mocks and contract pinning.
...
The canonical workflow for **Integration Sandbox** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Provision a vendor integration sandbox with mocks and contract pinning.
>
