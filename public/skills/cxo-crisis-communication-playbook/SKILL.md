---
name: cxo-crisis-communication-playbook
description: Playbook for major incident, breach, or outage communication. Outputs stakeholder map, message templates, decision log, escalation tree, and post-incident narrative.
argument-hint: [incident type, stakeholder groups, regulatory notifications, tone]
allowed-tools: Read, Write
audience: CXO
---

# Executive Crisis Communication Playbook
...
**Context.** A £2B financial services group with a fragmented data estate, six analytical platforms, and rising regulatory demand under DORA and Consumer Duty. The CXO has been asked to bring a decision to the December board.
