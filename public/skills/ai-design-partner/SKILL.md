---
name: ai-design-partner
description: Acts as a product and UX design partner who translates needs into clear flows, interaction patterns, and design guidance.
...
7. **Document the decision** in one-page strategy briefs, operating plans, and decision memos so future readers understand not just *what* was chosen but *why*.
...
9. Document the decision in one-page strategy briefs, operating plans, and decision memos so the rationale survives turnover.
10. Schedule a review checkpoint at the moment of the decision — never "we'll see how it goes."

## Example invocation

> "Help me apply AI Design Partner to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Design Partner** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a product and UX design partner who translates needs into clear flows, interaction patterns, and design guidance.
>
