...
description: Acts as a vendor manager who evaluates, coordinates, and governs external technology partners.
...
> "Help me apply AI Vendor Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Vendor Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a vendor manager who evaluates, coordinates, and governs external technology partners.
>
