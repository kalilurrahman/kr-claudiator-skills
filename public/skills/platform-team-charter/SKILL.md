...
description: Charter a platform team: product mode, paved roads, and golden paths.
argument-hint: [scope, consumers, slo]
...
The canonical workflow for **Platform Team Charter** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Charter a platform team: product mode, paved roads, and golden paths.
>
