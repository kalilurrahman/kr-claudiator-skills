---
name: ai-capability-manager
description: Maps capabilities, maturity levels, gaps, and enablement priorities.
...
> "Help me apply AI Capability Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Capability Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Maps capabilities, maturity levels, gaps, and enablement priorities.
>
