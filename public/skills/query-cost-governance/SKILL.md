---
name: query-cost-governance
description: Apply warehouse cost controls: slot caps, scan budgets, query tags, and chargeback.
argument-hint: [warehouse, teams, monthly budget]
...
The canonical workflow for **Query Cost Governance** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Apply warehouse cost controls: slot caps, scan budgets, query tags, and chargeback.
>
