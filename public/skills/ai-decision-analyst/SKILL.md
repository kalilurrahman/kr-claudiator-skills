---
name: ai-decision-analyst
description: Structures decision options, evidence, tradeoffs, and recommendation logic.
...
> "Help me apply AI Decision Analyst to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Decision Analyst** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Structures decision options, evidence, tradeoffs, and recommendation logic.
>
