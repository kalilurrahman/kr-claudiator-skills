...
description: Design a polyglot monorepo with Turbo/Nx, shared packages, hermetic builds, and selective CI.
argument-hint: [languages, scale, ci system, team size]
...
The canonical workflow for **Monorepo Strategy** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Design a polyglot monorepo with Turbo/Nx, shared packages, hermetic builds, and selective CI.
>
