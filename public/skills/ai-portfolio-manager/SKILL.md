...
description: Manages product and technology portfolios, prioritization, and investment allocation.
...
> "Help me apply AI Portfolio Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Portfolio Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Manages product and technology portfolios, prioritization, and investment allocation.
>
