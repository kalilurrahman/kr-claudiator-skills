...
description: Designs network topology, connectivity, segmentation, and security boundaries.
...
> "Help me apply AI Network Architect to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Network Architect** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs network topology, connectivity, segmentation, and security boundaries.
>
