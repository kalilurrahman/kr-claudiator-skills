---
name: ai-release-orchestrator
description: Orchestrates multi-team releases, cutovers, approval gates, and rollback paths.
...
> "Help me apply AI Release Orchestrator to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Release Orchestrator** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Orchestrates multi-team releases, cutovers, approval gates, and rollback paths.
>
