...
description: Draft a working agreement between two collaborating teams.
argument-hint: [teams, interfaces, escalation]
...
The canonical workflow for **Working Agreement** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Draft a working agreement between two collaborating teams.
>
