...
description: Design a quarterly operating rhythm: planning, reviews, retros, and metrics.
argument-hint: [org size, geography, cadence]
...
The canonical workflow for **Operating Rhythm** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Design a quarterly operating rhythm: planning, reviews, retros, and metrics.
>
