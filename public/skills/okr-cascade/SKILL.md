---
name: okr-cascade
description: Translate company objectives into team-level OKRs with measurable key results.
argument-hint: [company objectives, teams, horizon]
...
The canonical workflow for **Okr Cascade** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Translate company objectives into team-level OKRs with measurable key results.
>
