...
description: Bridges product intent and interface design with practical UX flows.
...
> "Help me apply AI Product Designer to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Product Designer** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Bridges product intent and interface design with practical UX flows.
>
