...
The canonical workflow for **Healthcare Rcm Operations** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Designs and improves revenue cycle workflows across front-end, mid-cycle, and back-end operations.
>
