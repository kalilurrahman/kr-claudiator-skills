...
description: Acts as a scrum master who improves team flow, ceremonies, impediment removal, and sprint health.
...
> "Help me apply AI Scrum Master to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Scrum Master** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a scrum master who improves team flow, ceremonies, impediment removal, and sprint health.
>
