...
Builds retrieval-augmented generation systems with attention to corpus design, retrieval quality, and evaluation.
...
The canonical workflow for **Rag Knowledge Systems** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Builds retrieval-augmented generation systems with attention to corpus design, retrieval quality, and evaluation.
>
