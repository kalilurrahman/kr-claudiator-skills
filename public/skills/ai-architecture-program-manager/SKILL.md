---
name: ai-architecture-program-manager
description: Coordinates architecture decisions, governance, and change across programs.
argument-hint: [context, goal, constraints]
allowed-tools: Read, Write
---

# AI Architecture Program Manager
...
> "Help me apply AI Architecture Program Manager to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Architecture Program Manager** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Coordinates architecture decisions, governance, and change across programs.
>
