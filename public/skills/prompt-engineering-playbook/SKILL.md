...
Creates structured prompting patterns for analysis, generation, evaluation, and workflow control.
...
The canonical workflow for **Prompt Engineering Playbook** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Creates structured prompting patterns for analysis, generation, evaluation, and workflow control.
>
