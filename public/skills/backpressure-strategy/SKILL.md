---
name: backpressure-strategy
description: Apply backpressure across async pipelines without dropping critical work.
argument-hint: [pipeline, sla, drop policy]
...
## When to use
Apply backpressure across async pipelines without dropping critical work.
...
The canonical workflow for **Backpressure Strategy** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Apply backpressure across async pipelines without dropping critical work.
>
