---
name: dependency-map
description: Map cross-team dependencies with risk, lead time, and unblock paths.
argument-hint: [initiatives, teams, horizon]
...
## When to use
Map cross-team dependencies with risk, lead time, and unblock paths.
...
The canonical workflow for **Dependency Map** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Map cross-team dependencies with risk, lead time, and unblock paths.
>
