...
description: Acts as a product owner who converts business needs into prioritized backlog items and acceptance criteria.
...
> "Help me apply AI Product Owner to this situation: <paste the context, goal, and constraints>"
...
The canonical workflow for **Ai Product Owner** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Acts as a product owner who converts business needs into prioritized backlog items and acceptance criteria.
>
