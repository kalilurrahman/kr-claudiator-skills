---
name: cio-digital-transformation-roadmap
description: Enterprise-wide digital transformation plan across process, data, platform, and people. Outputs value tree, wave plan, governance, KPI framework, and change-management approach.
argument-hint: [industry, current maturity, target state, 3-year budget, constraints]
