...
description: Adopt consumer-driven contract testing with Pact broker and verification gates.
argument-hint: [consumers, providers, broker]
...
## When to use
Adopt consumer-driven contract testing with Pact broker and verification gates.
...
The canonical workflow for **Contract Test Pact** runs in five stages. Each stage has an explicit exit criterion so the skill knows when to advance.
...
> **Context:** Adopt consumer-driven contract testing with Pact broker and verification gates.
>
