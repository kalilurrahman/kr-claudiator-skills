---
name: chro-workforce-transformation
description: Design an enterprise workforce plan covering skills, roles, sourcing, reskilling, and AI-augmentation. Outputs capability heat-map, role redesign, buy/build/borrow mix, and 24-month change plan.
argument-hint: [headcount, skills baseline, automation exposure, target productivity]
...
A decision-grade playbook for the **CHRO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A mid-cap enterprise where the CHRO has been asked to bring a decision to the next board meeting on the topic described in the argument hint.
...
**Governance.** Monthly steering chaired by the CHRO, quarterly board update, independent assurance review at each wave exit.
