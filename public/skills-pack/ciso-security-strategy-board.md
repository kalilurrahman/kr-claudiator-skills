---
name: ciso-security-strategy-board
description: 3-year cyber security strategy aligned to NIST CSF 2.0 and business risk. Outputs risk register, control roadmap, investment ask, metrics, and board narrative.
argument-hint: [threat landscape, current controls, regulatory obligations, risk appetite]
...
A decision-grade playbook for the **CISO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A £2B financial services group with a fragmented data estate, six analytical platforms, and rising regulatory demand under DORA and Consumer Duty. The CISO has been asked to bring a decision to the December board.
...
**Governance.** Monthly steering chaired by the CISO, quarterly board update, independent assurance review at each wave exit.
