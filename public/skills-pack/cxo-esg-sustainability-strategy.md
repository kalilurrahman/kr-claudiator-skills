---
name: cxo-esg-sustainability-strategy
description: Enterprise ESG strategy aligned to CSRD, ISSB, and TCFD. Outputs materiality matrix, decarbonisation pathway, governance model, disclosure roadmap, and board narrative.
argument-hint: [sector, jurisdictions, baseline emissions, regulatory scope]
allowed-tools: Read, Write
audience: CXO
---

# Executive ESG & Sustainability Strategy

A decision-grade playbook for the **CXO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A mid-cap enterprise where the CXO has been asked to bring a decision to the next board meeting on the topic described in the argument hint.
...
**Governance.** Monthly steering chaired by the CXO, quarterly board update, independent assurance review at each wave exit.
