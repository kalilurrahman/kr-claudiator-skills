---
name: ceo-quarterly-business-review
description: Assemble a rigorous QBR pack with strategic scorecard, financial deep-dive, market intelligence, risk register, and next-quarter bets. Outputs slide-ready narrative and appendix.
argument-hint: [period, financials, OKRs, market signals, competitive moves]
allowed-tools: Read, Write
audience: CEO
---

# CEO Quarterly Business Review Pack

A decision-grade playbook for the **CEO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A £2B financial services group with a fragmented data estate, six analytical platforms, and rising regulatory demand under DORA and Consumer Duty. The CEO has been asked to bring a decision to the December board.
...
**Governance.** Monthly steering chaired by the CEO, quarterly board update, independent assurance review at each wave exit.
