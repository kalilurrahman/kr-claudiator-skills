---
name: cfo-technology-investment-case
description: Rigorous investment case for a major technology or AI programme. Outputs NPV/IRR/payback, sensitivity analysis, risk-adjusted value, and CFO-grade approval memo.
argument-hint: [programme scope, cost profile, benefit hypotheses, discount rate]
...
A decision-grade playbook for the **CFO** and executive peers. Use it to move from ambiguous business context to a clear, defensible narrative that a board, exec committee, or investment committee can act on within one working session.
...
**Context.** A £2B financial services group with a fragmented data estate, six analytical platforms, and rising regulatory demand under DORA and Consumer Duty. The CFO has been asked to bring a decision to the December board.
...
**Governance.** Monthly steering chaired by the CFO, quarterly board update, independent assurance review at each wave exit.
