---
name: cxo-ai-governance-council
description: Stand up an enterprise AI governance council. Outputs charter, membership, decision rights, intake process, risk tiers, and audit cadence aligned to EU AI Act & NIST AI RMF.
argument-hint: [scope, jurisdictions, existing risk functions, target maturity]
