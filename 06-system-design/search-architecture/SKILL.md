...
description: Design scalable search systems for full-text, faceted, and semantic search. Outputs index design, query pipeline, relevance tuning, and performance optimisation.
argument-hint: [content type, query patterns, scale, latency targets, update frequency]
allowed-tools: Read, Write
---

# Search Architecture

SEARCH ARCHITECTURE is a critical engineering and product practice that requires systematic execution. This skill provides a proven framework for planning, executing, and validating search architecture work.
...
The canonical implementation pattern for search architecture work follows this structure:
...
The most frequent failure modes in search architecture work are:
